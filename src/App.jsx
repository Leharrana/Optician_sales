...
const OpticiansDashboard = () => {
  ...
  if (page === 'dashboard') {
    return (
      <div className="min-h-screen bg-gradient-to-br from-stone-100 via-amber-50 to-stone-100 p-2 sm:p-4">
      ...
      <div className="min-h-screen bg-gradient-to-br from-stone-100 via-amber-50 to-stone-100 p-2 sm:p-4">
        <div className="max-w-4xl mx-auto">
          <button
            ...
            className="mb-3 sm:mb-4 px-3 sm:px-4 py-2 bg-white rounded-lg border-2 border-stone-200 text-emerald-700 text-sm sm:text-base font-medium hover:bg-stone-50 transition shadow-md"
          >
            ← Back to Calendar
          </button>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-stone-50 to-emerald-50 p-2 sm:p-4">
      <div className="max-w-6xl mx-auto">
        <button
                  ...
                  {dailySales.map(({ day, total, fees, frame, lens }) => (
                    ...
                    >
                      <div className="text-center w-full">
                        ...
                        <p className={`text-xs sm:text-base md:text-xl font-bold ${total < 2600 ? 'text-red-600' : 'text-emerald-700'} break-words`}>
